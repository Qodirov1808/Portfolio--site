    ...
    <div class="card card-custom card-stretch gutter-b">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">Table Menu</span>
            ...
            {{-- <div class="card-toolbar">
                <ul class="nav nav-pills nav-pills-sm nav-dark-75">
                    ...
                    <li class="nav-item">
                        <a class="nav-link py-2 px-4" data-toggle="tab" href="{{ route('menu.index') }}">Week</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="pl-0">
                                ...
                                <div>
                                    <span class="font-weight-bolder">{{$menu->name}}</span>
