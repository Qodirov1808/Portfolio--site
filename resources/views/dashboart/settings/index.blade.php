    ...
    <div class="card card-custom card-stretch gutter-b">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">Setting Table</span>
            </h3>
            <div class="card-toolbar">
                <ul class="nav nav-pills nav-pills-sm nav-dark-75">                 
                    <li class="nav-item">
                        <a class="btn btn-success" href="{{ route('setting.create') }}">New Setting</a>
                    </li>                  
                </ul>
            </div>
        </div>
                ...
                <table class="table table-borderless table-vertical-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td >
                                <span><a href="/storage/images/{{ $setting->logo }}"><img width="200px" src="/storage/images/{{ $setting->logo }}" alt=""></a></span>                                
                            </td> 
                            <td >                               
                        ...
                        <td >                               
                            ...
                            <td class="text-right pr-0">
                                ...
                                <form style="display: inline"  action="{{ route('setting.destroy', $setting->id) }}" method="post">                                
                                    @method('DELETE')
                                    @csrf
